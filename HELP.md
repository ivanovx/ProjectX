...
* [Spring Data for Apache Cassandra](https://docs.spring.io/spring-boot/docs/3.1.0-SNAPSHOT/reference/htmlsingle/#data.nosql.cassandra)
...
```
$ docker run --rm -p 8080:8080 webapp:0.0.1-SNAPSHOT
```
